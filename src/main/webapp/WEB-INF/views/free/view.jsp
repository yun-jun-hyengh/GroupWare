	                                ...
	                                <tr>
	                                    <td colspan="2" >
	                                        <p >
	                           				...
	                           				<c:forEach var="file" items="${freefile}">
	                                    ...
	                                    <td>
	                                        <span style='float:right'>
	                                           <button type="submit" id="list_btn" class="btn btn-default">목록</button>
												...
												<a type="button" class="btn btn-default" href="/free/writer">글쓰기</a>
                                    	    </span>
                                	    </td>
                            	    </tr>
                        	    </thead>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#list_btn").click(function(){
			location.href = "/free/freelist?page=${scri.page}"
		...
		$(".replyWriteBtn").on("click", function(){
			...
			formObj1.attr("action", "/free/replyWrite");
			formObj1.submit();
		});
	...
	deleteReplyBtns.forEach( (element) => {	// 모든 댓글 삭제버튼에 대해서
		element.onclick = (event) => {	// 버튼을 클릭하면 실행할 이벤트 함수를 부여한다
			...
			if(answer === true) {	// 확인을 받으면
				location.href = '${cpath}/free/deleteReply/' + rno;	// 해당 주소로 이동
